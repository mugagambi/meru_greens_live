                ...
                <form class="form-horizontal" method="POST" action="{{route('teams.update', ['team' => $team->id])}}"
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="file" name="pic"
                                       value="{{ old('pic') }}"
                                       id="inputPic">
                                <p><b>previous featured pic : </b><a
                                            href="{{asset('uploads').'/'.$team->pic}}">{{$team->pic}}</a>
                                </p>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="inputPassword3"
                                       value="{{ $team->facebook }}" name="facebook"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="inputPassword3"
                                       value="{{ $team->twitter }}" name="twitter"
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" rows="3" name="about"
                                      placeholder="short detail about this team member">{{ $team->about  }}</textarea>
                            </div>
                        </div>
                    ...
                    <div class="box-footer">
                        ...
                        <button type="submit" class="btn btn-success pull-right">Update Team Member Details</button>
                    </div>
                    <!-- /.box-footer -->
                </form>
            </div>
