        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title"> Front Page Image Slider <small>You can have maximum of 3 images</small>
                    </h3>
                    <a href="{{route('slider.create')}}" role="link" class="btn btn-success pull-right btn-flat">ADD
                        SLIDER</a>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        @foreach($sliders as $slider)
                            <tr>
                                <td>
                                    <a href="{{asset('uploads').'/'.$slider->image}}">
                                        {{$slider->image}}</a>
                                </td>
                                <td>{{$slider->title}}</td>
                                <td>
