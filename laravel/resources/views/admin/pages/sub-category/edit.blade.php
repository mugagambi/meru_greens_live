        ...
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="box box-info">
                ...
                <form class="form-horizontal" method="POST"
                      action="{{route('sub-category.update', ['sub_category' => $category->id])}}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="file" name="pic"
                                       value="{{ old('pic') }}"
                                       id="inputPic">
                                <p><b>Previous Image: </b><a href="{{asset('uploads').'/'.$category->pic}}">
                                        {{$category->pic}}</a></p>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control" name="main">
                                    <option value="Fruits" {{ ($category->category == 'Fruits') ? 'selected="selected"' : '' }}>
                                        Fruits
                                    </option>
                                    <option value="Vegetables" {{ ($category->category == 'Vegetables') ? 'selected="selected"' : '' }}>
                                        Vegetables
                                    </option>
                                    <option value="Others" {{ ($category->category == 'Others') ? 'selected="selected"' : '' }}>
                                        Others
                                    </option>
                                </select>
                            </div>
                    ...
                    <div class="box-footer">
                        ...
                        <button type="submit" class="btn btn-success pull-right">Update sub category</button>
                    </div>
                    <!-- /.box-footer -->
                </form>
            </div>
