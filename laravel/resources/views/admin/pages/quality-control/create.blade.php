...
@section('breadcrump')
    <h1>
        Add Company Quality Control Policy
    </h1>
    <ol class="breadcrumb">
        <li><a href="{{route('admin.dashboard')}}"><i class="fa fa-dashboard"></i> Dashboard</a></li>
        <li class="active">Add Company Quality Control Policy</li>
    </ol>
@endsection
@section('content')
        ...
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="box box-info">
                <div class="box-header with-border">
                    <h3 class="box-title">Add Company Quality Control Policy</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <form class="form-horizontal" method="POST" action="{{route('admin.quality.store')}}">
                    ...
                    <div class="box-footer">
                        <button type="submit" class="btn btn-success pull-right">Add policy</button>
                    </div>
                    <!-- /.box-footer -->
                </form>
            </div>
