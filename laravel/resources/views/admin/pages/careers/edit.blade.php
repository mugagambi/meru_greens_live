...
@section('breadcrump')
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Update new vacancy</li>
    </ol>
@endsection
@section('content')
        ...
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="box box-info">
                <div class="box-header with-border">
                    <h3 class="box-title">Update new vacancy</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <form class="form-horizontal" method="POST"
                      action="{{route('careers.update', ['career' => $career->id])}}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="email" class="form-control" name="email" id="inputEmail3"
                                       value="{{ $career->application_email }}"
                                       placeholder="Email">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                <p><b>previous featured image : </b><a
                                            href="{{asset('storage').'/'.$career->image}}">view image</a>
                                </p>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" rows="3"
                                          ...
                                          name="short_description">{{ $career->short_description }}</textarea>
                            </div>
                        </div>
                    ...
                    <div class="box-footer">
                        ...
                        <button type="submit" class="btn btn-success pull-right">Update vacancy</button>
                    </div>
                    <!-- /.box-footer -->
                </form>
            </div>
